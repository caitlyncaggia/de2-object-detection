...
MoveForward:
	...
	; heading and speed:
	IN	   THETA
	STORE  DesTheta    ; desired heading (0 degree change)
	LOAD   FMid
...
TestForward:
	IN     LPOS
	ADDI    -420
	JNEG   MoveForward      ; not there yet; keep moving
	LOAD Zero
	OUT LVELCMD
	OUT RVELCMD
	RETURN
...
TestBackward:
	IN     LPOS
	ADDI   420
	JPOS   MoveBackward      ; not there yet; keep moving
	LOAD Zero
	OUT LVELCMD
	OUT RVELCMD
	RETURN
